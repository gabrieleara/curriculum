...
\documentclass[a4paper,en,online,print,colorlinks,extended]{adcv-template/adcv}
...
\begin{adcvtabletwo}
  ...
  \adcvrowmulti{Gabriele writes from time to time chapters and sections of IT
    ...
    examples.
    % The complete list of textbooks to which Gabriele collaborated is in
    % \hyperref[sec:bookchapters]{Book Chapters}.
    }
  \adcvrowskip
...
\begin{adcvpresentations}
  ...
  \adcvpresentation{Comparative Evaluation of Kernel Bypass Mechanisms for
    High-performance Inter-container Communications}{
      \href{https://www.youtube.com/watch?v=cQ3ecv6TVZc}{[Online on YouTube]}
    Prague, Czech Republic, May 7, 2020}
